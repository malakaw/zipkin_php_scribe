  ...
  public function write($output) {
    ...
    if ($this->host !== null) {
      if (!is_object($this->host)) {
        throw new TProtocolException('Bad type in Annotation structure.', TProtocolException::INVALID_DATA);
      }
...
class BinaryAnnotation {
  ...
  public function write($output) {
    ...
    if ($this->host !== null) {
      if (!is_object($this->host)) {
        throw new TProtocolException('Bad type in BinaryAnnotation structure.', TProtocolException::INVALID_DATA);
      }
  ...
  public function write($output) {
    ...
    if ($this->annotations !== null) {
      ...
      if (!is_array($this->annotations)) {
        throw new TProtocolException('Bad type in annotations structure.', TProtocolException::INVALID_DATA);
      }
    ...
    if ($this->binary_annotations !== null) {
      if (!is_array($this->binary_annotations)) {
        throw new TProtocolException('Bad type in binary_annotations structure.', TProtocolException::INVALID_DATA);
      }
